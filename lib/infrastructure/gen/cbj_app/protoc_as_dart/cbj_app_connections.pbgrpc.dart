...
@$pb.GrpcServiceName('CBJAppConnections.CyBearJinniApp')
class CyBearJinniAppClient extends $grpc.Client {
  static final _$cBJAppGetSmartDeviceInformation = $grpc.ClientMethod<$0.CompInfoSB, $0.CBJCommendStatus>(
  ...
  static final _$getCompAppInfo = $grpc.ClientMethod<$0.CompAppInfo, $0.CompAppInfo>(
  ...
  $grpc.ResponseFuture<$0.CBJCommendStatus> cBJAppGetSmartDeviceInformation($0.CompInfoSB request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$cBJAppGetSmartDeviceInformation, request, options: options);
  }

  $grpc.ResponseFuture<$0.CompAppInfo> getCompAppInfo($0.CompAppInfo request, {$grpc.CallOptions? options}) {
...
abstract class CyBearJinniAppServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.CBJCommendStatus> cBJAppGetSmartDeviceInformation_Pre($grpc.ServiceCall call, $async.Future<$0.CompInfoSB> request) async {
    return cBJAppGetSmartDeviceInformation(call, await request);
  }

  $async.Future<$0.CompAppInfo> getCompAppInfo_Pre($grpc.ServiceCall call, $async.Future<$0.CompAppInfo> request) async {
    return getCompAppInfo(call, await request);
  }

  $async.Future<$0.CBJCommendStatus> cBJAppGetSmartDeviceInformation($grpc.ServiceCall call, $0.CompInfoSB request);
  $async.Future<$0.CompAppInfo> getCompAppInfo($grpc.ServiceCall call, $0.CompAppInfo request);
}
